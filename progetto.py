...
TEMI = {
    ...
    "yellow": {
        "sfondo_finestra": "#DAA520",
        "sfondo_testo": "#FFFFE0",
        "colore_testo": "#000000",
        "colore_keyword": "#8B4513",
        "colore_builtin": "#000080",
        "colore_eccezione": "#cc0000",
    ...
    "red": {
        "sfondo_finestra": "#2a0000",
        "sfondo_testo": "#1a0000",
        "colore_testo": "#f5f5f5",
        "colore_keyword": "#E71827",
        "colore_builtin": "#FF4654",
    ...
    "purple": {
        "sfondo_finestra": "#1a0b2e",
        "sfondo_testo": "#0f051a",
        "colore_testo": "#e0e6ed",
        "colore_keyword": "#9C51B6",
        "colore_builtin": "#733381",
        "colore_eccezione": "#ff4081",
...
KEYWORDS_PYTHON = [
    ...
    "True", "False", "None", "and", "or", "not", "is", "in", "import", "from", "as", 
    "global", "nonlocal", "with", "del", "async", "await", "match", "case"
]
...
EXCEPTIONS_PYTHON = [
    ...
    "KeyboardInterrupt", "StopIteration", "RuntimeError", "AssertionError"
]
...
def controlla_coda_output():
    while not coda_output.empty():
        ...
        cmd_area.see(tk.END)  
    root.after(30, controlla_coda_output)
...
def esegui_evidenziazione():
    for tag in ["keyword", "builtin", "exception", "method", "string", "comment", "number", "function"]:
